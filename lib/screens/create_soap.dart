                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: textFieldForm(
                            nameController, textData().getLyePurity(), true),
                      ),
                      Expanded(
                        child: textFieldForm(
                            nameController, textData().getLyeCount(), true),
                      ),
                      Visibility(
                        visible: themeData.type == TYPE.E_COLD,
                        child: Expanded(
                          child: textFieldForm(
                              nameController, textData().getWater(), true),
                        ),
                      ),
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            const Padding(padding: EdgeInsets.only(left: 8)),
                            Expanded(
                              child: textFieldForm(nameController,
                                  textData().getPureSoap(), true),
                            ),
                            Expanded(
                              child: textFieldForm(nameController,
                                  textData().getSolvent(), true),
                            ),
                            Expanded(
                              child: textFieldForm(
                                  nameController, textData().getSugar(), true),
                            ),
                            const Padding(padding: EdgeInsets.only(right: 8)),
                          ],
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: textFieldForm(nameController,
                                  textData().getGlycerine(), true),
                            ),
                            Expanded(
                              child: textFieldForm(nameController,
                                  textData().getEthanol(), true),
                            ),
                            const Padding(padding: EdgeInsets.only(right: 8)),
                          ],
                        ),
            ...
            children: [
              Expanded(
                child: SizedBox(
                  ...
                  child: TextButton(
                      ...
                      child: Row(
                        mainAxisAlignment:
                            curIndex > 0 && curIndex < soap_lastPage
              ...
              Expanded(
                ...
                child: AnimatedContainer(
                  duration: const Duration(milliseconds: 500),
                  decoration: BoxDecoration(
                      color: curIndex > 0 && curIndex < soap_lastPage
                          ? themeData.textColor
                  ...
                  child: TextButton(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Icon(
                            curIndex == soap_lastPage
                                ? Icons.save
                                : (curIndex == soap_lastPage - 1
