  ...
  for (int i = 0; i < list.length; i++) {
    try {
      ...
      oil = Oil(
          ...
          korean: data[1],
          english: data[2],
          NaOH: double.parse(data[3]),
          KOH: double.parse(data[4]),
          fat: List.generate(FAT_TYPE.LENGTH.index,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () => {Navigator.pushNamed(context, '/create/soap')},
